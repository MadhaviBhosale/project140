...
def predict():
    ...
    if not review:
        ...
        # Call the predict method from 'text_sentiment_prediction' module
...
def save():
    # Extracting date, product name, review, and sentiment from the JSON data
...
def bot():
    ...
    # Call the method to get the bot response
